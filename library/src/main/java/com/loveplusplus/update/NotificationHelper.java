...
public class NotificationHelper extends ContextWrapper {
    ...
    public NotificationHelper(Context base) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            ...
            NotificationChannel mChannel = new NotificationChannel(CHANNEL_ID, "Apply update", NotificationManager.IMPORTANCE_LOW);
            mChannel.setDescription("App has new version");
            mChannel.enableLights(true); // Is the red dot displayed in the top right corner of the desktop icon?
    ...
    private int getSmallIcon() {
        // Set the icon of the nofication directly read the icon of the millet push configuration
